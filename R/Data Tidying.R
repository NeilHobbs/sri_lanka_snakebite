...
#Import datasets
Snakes2008 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2008")
Snakes2009 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2009")
Snakes2010 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2010")
Snakes2011 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2011")
Snakes2012 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2012")
Snakes2013 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2013")
Snakes2014 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2014")
Snakes2015 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2015")
Snakes2016 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2016")
Snakes2017 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2017")
Snakes2018 = read_excel("Snake_Bite_Data_name_update.xlsx", sheet = "2018")

snakes2008_A = Snakes2008[7:431, ] # These are the rows with data values in them (excluding totals in the final row)
snakes2009_A = Snakes2009[7:445, ]
snakes2010_A = Snakes2010[7:461, ]
snakes2011_A = Snakes2011[7:478, ]
snakes2012_A = Snakes2012[7:484, ]
snakes2013_A = Snakes2013[7:497, ]
snakes2014_A = Snakes2014[7:504, ]
snakes2015_A = Snakes2015[7:515, ]
snakes2016_A = Snakes2016[7:543, ]
snakes2017_A = Snakes2017[7:547, ]
snakes2018_A = Snakes2018[7:565, ]
...
snakes = snakes2018_A  #update year for each extraction. Should really be done as a loop
...
snakes_tidy = df%>% #update snakes year
  mutate(Year = 2018)%>% #update year
  rename(Count = row)%>% 
  rename(Hospital = snakes....3)

write.csv(snakes_tidy, ".\\snakes2018.csv") #update year
